...
SubscriptionCard.propType = {
    id: PropType.oneOfType([PropType.number, PropType.string]).isRequired,
    name: PropType.string.isRequired,
    price: PropType.number.isRequired,
    durationInMonth: PropType.number.isRequired,
    features: PropType.array.isRequired,
    isPremium: PropType.bool,
    onSelectSubscription: PropType.func,
};
